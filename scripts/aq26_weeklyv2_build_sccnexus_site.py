...
def copy_assets(asset_root:Path, site:Path):
    ...
    (target/"aq26_evidence_lake.js").write_text(evidence_lake_js(),encoding="utf-8")
...
def evidence_lake_section():
    return """<section class='section'>
  <div class='section-title'>
    <h2>Google Drive evidence lake</h2>
    <p>Controlled archive status for provider outputs, checksums and website-ready indexes. Raw/large files stay in Drive; the public site receives only compact summaries.</p>
  </div>
  <div id='aq26-evidence-lake' data-index='data/providers/laqn/evidence_lake/latest_index.json'>
    <div class='callout'><strong>Evidence lake status loading.</strong><p>The website will show the latest LAQN Drive export once AQ26 Evidence Lake Package has run.</p></div>
  </div>
</section>"""
