...
SECRET_NAMES = [
    ...
    "GDRIVE_FOLDER_ID", "GDRIVE_SERVICE_ACCOUNT", "GEMINI_API_KEY", "GEMINI_MODEL", "METOFFICE_API_KEY",
    ...
    "SMTP_PASSWORD", "SMTP_USERNAME", "SCCAIRQUALITY_SSH_PASSWORD", "SCC_UNREDACTED_PASSWORD",
    "WAQI_TOKEN", "AIRQUALITY_HOSTINGER_PUBLIC_HTML_DIR",
]
